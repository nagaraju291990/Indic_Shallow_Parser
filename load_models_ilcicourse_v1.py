...
def load_online_model(lang, model_id):
    print ('Language :', lang)
    print ('/media/vandan/zion/Shallow_parser_2/course/model_output_'+mlm[lang]+'_ilciposcourse/saved_model/model-'+model_id)
    model_path = '/media/vandan/zion/Shallow_parser_2/course/model_output_'+mlm[lang]+'_ilciposcourse/saved_model/model-'+str(model_id)
